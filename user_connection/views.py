...
def send_request(request):
    ...
    return Response({"message": SuccessMessage.SEND_REQUEST_SUCCESS, "data": serializer.data}, status=status.HTTP_201_CREATED)
...
def handle_friend_request(request):
    ...
    if action == 'accept':
        ...
        return Response({"status": "success", "message": SuccessMessage.ACCEPT_REQUEST_SUCCESS})

    elif action == 'reject':
        connection.delete()

        return Response({"status": "success", "message":  SuccessMessage.REJECT_REQUEST_SUCCESS})
...
def withdraw_send_request(request):
    ...
    connection.delete()
    return Response({"message": SuccessMessage.WITHDRAW_REQUEST_SUCCESS}, status=status.HTTP_200_OK)
...
def block_user(request):
    ...
    return Response({"message": SuccessMessage.BLOCK_USER_SUCCESS, "data": serializer.data}, status=status.HTTP_201_CREATED)
...
def report_user(request):
    ...
    return Response({"message": SuccessMessage.REPORT_USER_SUCCESS, "data": serializer.data}, status=status.HTTP_201_CREATED)
